 ...
 */
type ParsedViewerConfig = Omit<ViewerConfig, 'adapter' | 'plugins' | 'defaultYaw' | 'defaultPitch' | 'moveInertia' | 'fisheye' | 'requestHeaders' | 'withCredentials' | 'navbar'> & {
 ...
 */
declare function keyPressMatch(e: KeyboardEvent, pattern: string): boolean;
...
declare const index_keyPressMatch: typeof keyPressMatch;
