    ...
    return (
        <>
            ...
            >
                {/* BG miring */}
                <div
                    className="absolute top-120 left-0 right-0 h-100 bg-[#FE4D01] transform -skew-y-6 origin-top-left z-0"/>
                ...
                <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-20">
                    ...
                    >
                        ...
                        >
                            {/* desktop carousel */}
                            <div
                                className="hidden md:flex relative w-full h-[380px] items-center justify-center overflow-hidden">
