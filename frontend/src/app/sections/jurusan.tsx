...
export default function Jurusan({ hideDecoration = false }: JurusanProps) {
  ...
  return (
    <section id="jurusan" className="relative py-30 bg-white overflow-hidden">
      ...
      {/* Dekorasi kotak biru (tanpa animasi masuk) */}
      {!hideDecoration && (
        <>
          <div className="absolute top-0 left-0 w-[50px] h-[50px] bg-[#243771] z-10" />
          <div className="absolute top-12 left-12 w-[50px] h-[50px] bg-[#243771] z-10" />
        </>
      )}
    </section>
  );
