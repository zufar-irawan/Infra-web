...
export default function LaporanPage() {
  ...
  const summaryStats = React.useMemo(() => {
    ...
    const totalStudents = classStats.reduce((sum, row) => sum + row.studentCount, 0);
    const totalRecords = classStats.reduce((sum, row) => sum + row.records, 0);
    const overallAverage = classStats.length > 0
      ? classStats.reduce((sum, row) => sum + row.average, 0) / classStats.length
      : 0;
  ...
  return (
    <div className="overflow-y-auto min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
      <div className="w-full max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Laporan Nilai Kelas</h1>
              <p className="text-sm text-gray-600 mt-1">Ringkasan rata-rata nilai berdasarkan hasil ujian untuk setiap kelas</p>
            </div>
          </div>
        </div>
        ...
        {!loading && !error && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold text-gray-900">{summaryStats.totalClasses}</h3>
              <p className="text-sm text-gray-600 mt-1">Total Kelas</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold text-gray-900">{summaryStats.totalStudents}</h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold text-gray-900">{summaryStats.totalRecords}</h3>
              <p className="text-sm text-gray-600 mt-1">Total Nilai</p>
            </div>

            {/* Overall Average Card */}
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center justify-between mb-3">
              ...
              <h3 className="text-2xl font-bold text-white">{summaryStats.overallAverage}</h3>
              <p className="text-sm text-white/90 mt-1">Rata-rata Keseluruhan</p>
            </div>
          </div>
        )}
        ...
        {loading && (
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-md">
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <p className="text-sm text-gray-700 font-medium">Memuat data laporan...</p>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4">
              <h2 className="text-lg font-semibold text-white flex items-center gap-2">
                ...
                Detail Rata-rata Nilai per Kelas
              </h2>
            </div>
                      ...
                      >
                        <td className="py-4 px-6">
                          <div className="flex items-center gap-3">
                            <div className="bg-gradient-to-br from-orange-100 to-orange-200 w-10 h-10 rounded-xl flex items-center justify-center font-bold text-orange-600 group-hover:scale-110 transition-transform">
                              {index + 1}
                            </div>
                      ...
                      <td colSpan={4} className="py-12 text-center">
                        <div className="flex flex-col items-center justify-center space-y-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Belum ada data nilai yang tersedia untuk kelas-kelas</p>
                          </div>
                        </div>
                      </td>
                    </tr>
              ...
              <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                <div className="flex items-center justify-between text-sm text-gray-600">
                  <span className="flex items-center gap-2">
                    ...
                    Menampilkan <span className="font-semibold text-gray-900">{classStats.length}</span> kelas
                  </span>
                  <span className="text-xs text-gray-500">
                    Data diperbarui otomatis saat halaman dimuat
                  </span>
                </div>
              </div>
            )}
