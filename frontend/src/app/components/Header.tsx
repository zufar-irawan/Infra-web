        ...
        <div className="w-full max-w-4/5 mx-auto flex items-center justify-between">
          ...
          {!isMobile ? (
            <nav className="hidden md:flex items-center gap-6 text-[15px] text-white relative">
              {[
                { id: "home", name_id: "Beranda", name_en: "Home", href: "/" },
                {
                  id: "tentang",
                  ...
                  submenu: [
                    ...
                    { href: "/profil/mitra", id: "Mitra", en: "Partners" },
                  ],
                },
                { id: "program", name_id: "Program Keahlian", name_en: "Expertise Programs", href: "/program" },
                {
                  id: "siswa",
                ...
                menu.submenu ? (
                  ...
                  >
                    ...
                    {hoveredDropdown === menu.id && (
                      <div className="absolute left-0 mt-3 text-sm bg-white/95 shadow-lg rounded text-orange-600 w-52 transition duration-300">
      ...
      >
        ...
        <div className="flex flex-col px-6 py-4 space-y-2">
          {[
            ...
            { title_id: "Program Keahlian", title_en: "Expertise Programs", href: "/program" },
            {
            ...
            <div key={i}>
              {menu.submenu ? (
                <div className="relative">
                  <button
                    onClick={() =>
                      setOpenMobileDropdown(openMobileDropdown === menu.title_id ? null : menu.title_id)
                    }
                ...
                <a
                  href={menu.href}
                  className="relative py-2 block font-medium group"
                >
                  {lang === "id" ? menu.title_id : menu.title_en}
                  <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-white transition-all duration-300 group-hover:w-full"></span>
                </a>
